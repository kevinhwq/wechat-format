var WxRenderer = function (opts) {
    ...
    this.getRenderer = function () {
        ...
        renderer.heading = function (text, level) {
            if (level == 1) {
                return '<h1 ' + S('h1') + '><span>' + text + '</span></h1>'
            } else if (level == 2) {
                return '<h2 ' + S('h2') + '><span>' + text + '</span></h2>'
            } else {
                return '<h3 ' + S('h3') + '><span>' + text + '</span></h3>'
            }
        }
        ...
        renderer.hr = function () {
            return '<hr style="margin: 50px; border-style: solid;border-width: 1px 0 0;border-color: rgba(0,0,0,0.1);-webkit-transform-origin: 0 0;-webkit-transform: scale(1, 0.5);transform-origin: 0 0;transform: scale(1, 0.5);">';
        }
        return renderer
    }
}